...
declare_instructions! {
    ...
    LoadStatic4 loadst4,
    LoadStatic8 loadst8,
    LoadStaticBytes loadstn,

    LoadConst1 loadc1,
    LoadConst2 loadc2,
    LoadConst4 loadc4,
    LoadConst8 loadc8,
    LoadConstBytes loadcn,
    ...
    JumpNotZeroConst1 jnzc1,
    JumpNotZeroConst2 jnzc2,
    JumpNotZeroConst4 jnzc4,
    JumpNotZeroConst8 jnzc8,
    JumpNotZero1 jnz1,
    JumpNotZero2 jnz2,
    JumpNotZero4 jnz4,
    JumpNotZero8 jnz8,
    ...
    JumpZero4 jz4,
    JumpZero8 jz8,
    JumpErrorConst jerrc,
    JumpError jerr,
    JumpNoErrorConst jnoerrc,
    JumpNoError jnoerr,
